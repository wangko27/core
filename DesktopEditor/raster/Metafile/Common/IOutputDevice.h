...
namespace MetaFile
{
	...
	public:
		...
		virtual void DrawString(NSStringUtils::CStringUTF32& oString, double dX, double dY, double* pDx,
					int iGraphicsMode = 1, double dXScale = 1, double dYScale = 1) = 0;

		virtual void DrawDriverString(NSStringUtils::CStringUTF32& oString, const std::vector<TPointD>& arPoints) = 0;
